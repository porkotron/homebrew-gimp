class Libgimp20AT21024 < Formula
  desc "Headers and other files for compiling plugins for GIMP"
  homepage "https://www.gimp.org/"
  url "https://gitlab.gnome.org/GNOME/gimp.git", tag: "GIMP_2_10_24"
  version "2.10.24"
  ...
  %w[
    ...
    pango
    poppler
    porkotron/gimp/pygtk
    porkotron/gimp/mypaint-brushes
  ].each do |d|
    depends_on d
  end
  ...
  def install
    ...
    bin.install "tools/.libs/gimptool-2.0"
